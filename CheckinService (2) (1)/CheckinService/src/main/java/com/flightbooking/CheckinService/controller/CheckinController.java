...
public class CheckinController {
   ...
   public Checkin checkin(@RequestBody Checkin bookingid,@PathVariable("bookingid") int bookingid1)
 {
  ...
  /* @PutMapping("/checkinstatus")
   public Checkin flightcheckin(@RequestBody Checkin checkin,@PathVariable String Checkinstatus) {
	   return checkinservice.updatecheckinstatus(checkin);
   }*/
   @PutMapping("/checkinstatus")
   public Checkin checkinstatus(@RequestBody Checkin checkin) {
